...
function memulai(){
  suratin.style="transition:.8s;transform:scale(.1);opacity:0";
  ket.style="transition:.8s;transform:scale(.1);opacity:0";
...
function ftmuncul(){
  ...
  if(ftganti==1){fotoakhir.src = fotoakhir2.src;fotoakhir.style="display:inline-flex;opacity:1;transition:.7s;transform:scale(1)";}
  if(ftganti==2){fotoakhir.src = fotoakhir3.src;fotoakhir.style="display:inline-flex;opacity:1;transition:.7s;transform:scale(1)";}
}
function fthilang(){fotoakhir.style="opacity:1;transition:.7s;transform:scale(.1)";}

function tombol(){Tombol.style="opacity:1;transform:scale(1)";Bn.style="margin:12px";ftom=1;}
...
function animkata2() {
  kalimat.innerHTML = kalimat2.innerHTML; kalimatb.innerHTML = kalimatb2.innerHTML;
  kalimatc.innerHTML=""; kalimat.style.opacity="1"; kalimatb.style.opacity="1";
  setTimeout(otomatis2b,2500);
}
function otomatis2b(){
  kalimatb.innerHTML = ""; kalimatc.innerHTML = kalimatc2.innerHTML; kalimatc.style.opacity="1";
...
function animkata3() {
  kalimat.innerHTML = kalimat3.innerHTML; kalimatb.innerHTML = kalimatb3.innerHTML;
...
function teksnimasi(){
  ...
  new TypeIt("#kalimatc", {
    ...
    afterComplete: function () {
      ...
      fotoakhir.style="opacity:1;transition:.7s;transform:scale(0)";
      setTimeout(() => {
        fotoakhir.src = fotoakhir4.src;
        fotoakhir.style="opacity:1;transition:.7s;transform:scale(1)";
      }, 300);
    }
  }).go();
}
...
async function diterima(){
  ...
  bq.style = "opacity:1;transform: scale(1);transition:.7s;";
  Tombol.style="opacity:0;transition:.5s;transform:scale(.1)";
  otomatis2();
}
