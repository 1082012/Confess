...
let jumlahKlik = 0, sudah = false, jumlahSkala = 1;
let pesanwhatsapp = "";
let txtIsiPesan;
let audio;
...
function teksnimasi() {
  ...
  new TypeIt("#kalimatc", {
    ...
    afterComplete: function () {
      ...
      fotoakhir.style =
        "display:inline-flex;opacity:1;transition:all .7s ease;transform:scale(0)";
      setTimeout(() => {
